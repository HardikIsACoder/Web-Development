...
const locations = [
    {
        ...
        text: "You are in the town square. You see a sign that says \" Go to store\"."
    },
    {
        name: "store",
...
function goFight() {
    ...
    // updating css file through javascript
...
function attack(){
    ...
    // above the math random function is used to generate a random no. betwee 0 and xp
    healthText.innerText = health;
    monsterHealthText.innerText = monsterHealth;
    if(health <= 0){
        lose();
...
function defeatMonster(){
    ...
    // the math.floor function is used to round off the value to the nearest whole no.
